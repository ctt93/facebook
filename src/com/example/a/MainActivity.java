...
public class MainActivity extends Activity {
	...
	public void locate(View v){
		...
		startActivityForResult(intent, 1);
			...
			Toast.makeText(MainActivity.this, "请先识别身份", Toast.LENGTH_SHORT).show();
		}
	...
	protected void onActivityResult(int requestCode,int resultCode,Intent backintent){
		...
		case 1:
			if(resultCode==RESULT_OK){
				  preqiandaotime = backintent.getStringExtra("preqiandaotime");
		            dakatime=backintent.getStringExtra("dakatime");
		            latitude=backintent.getStringExtra("latitude");
		            longtitude=backintent.getStringExtra("longtitude");
